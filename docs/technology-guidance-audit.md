...
The backend test suite grew from 167 to **598 tests** during the remediation — a 258% increase over the baseline (3.58× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  210 (was 50)
- **Api.Tests**:          107 (was 105)

The 431 new tests split as:

...
The backend test suite grew from 167 to **690 tests** during the remediation — a 313% increase over the baseline (4.13× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  302 (was 50)
- **Api.Tests**:          107 (was 105)

The 523 new tests split as:

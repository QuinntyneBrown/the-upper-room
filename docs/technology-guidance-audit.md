...
The backend test suite grew from 167 to **634 tests** during the remediation — a 280% increase over the baseline (3.80× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  246 (was 50)
- **Api.Tests**:          107 (was 105)

The 467 new tests split as:

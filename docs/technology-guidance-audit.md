...
The backend test suite grew from 167 to **528 tests** during the remediation — a 216% increase over the baseline (now over 3× the original count):

- **Domain.Tests**:       252 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  160 (was 50)
- **Api.Tests**:          107 (was 105)

The 361 new tests split as:

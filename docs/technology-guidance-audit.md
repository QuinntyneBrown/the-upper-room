...
The backend test suite grew from 167 to **659 tests** during the remediation — a 295% increase over the baseline (3.95× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  271 (was 50)
- **Api.Tests**:          107 (was 105)

The 492 new tests split as:

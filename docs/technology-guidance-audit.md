...
The backend test suite grew from 167 to **568 tests** during the remediation — a 240% increase over the baseline (now over 3× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  180 (was 50)
- **Api.Tests**:          107 (was 105)

The 401 new tests split as:

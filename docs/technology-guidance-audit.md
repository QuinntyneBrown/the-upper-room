...
The backend test suite grew from 167 to **590 tests** during the remediation — a 253% increase over the baseline (3.53× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  202 (was 50)
- **Api.Tests**:          107 (was 105)

The 423 new tests split as:

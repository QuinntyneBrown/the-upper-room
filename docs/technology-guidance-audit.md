...
The backend test suite grew from 167 to **554 tests** during the remediation — a 232% increase over the baseline (now over 3× the original count):

- **Domain.Tests**:       267 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  171 (was 50)
- **Api.Tests**:          107 (was 105)

The 387 new tests split as:

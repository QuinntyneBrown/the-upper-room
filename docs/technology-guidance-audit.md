...
The backend test suite grew from 167 to **563 tests** during the remediation — a 237% increase over the baseline (now over 3× the original count):

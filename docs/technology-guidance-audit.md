...
The backend test suite grew from 167 to **677 tests** during the remediation — a 305% increase over the baseline (4.05× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  289 (was 50)
- **Api.Tests**:          107 (was 105)

The 510 new tests split as:

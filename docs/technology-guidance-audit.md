...
The backend test suite grew from 167 to **628 tests** during the remediation — a 276% increase over the baseline (3.76× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  240 (was 50)
- **Api.Tests**:          107 (was 105)

The 461 new tests split as:

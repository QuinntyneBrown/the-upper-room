...
The backend test suite grew from 167 to **617 tests** during the remediation — a 269% increase over the baseline (3.69× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  229 (was 50)
- **Api.Tests**:          107 (was 105)

The 450 new tests split as:

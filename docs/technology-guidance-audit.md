...
The backend test suite grew from 167 to **547 tests** during the remediation — a 228% increase over the baseline (now over 3× the original count):

- **Domain.Tests**:       267 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  164 (was 50)
- **Api.Tests**:          107 (was 105)

The 380 new tests split as:

...
The backend test suite grew from 167 to **670 tests** during the remediation — a 301% increase over the baseline (4.01× the original count — past the 4× milestone):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  282 (was 50)
- **Api.Tests**:          107 (was 105)

The 503 new tests split as:

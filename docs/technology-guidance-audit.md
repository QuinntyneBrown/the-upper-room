...
The backend test suite grew from 167 to **673 tests** during the remediation — a 303% increase over the baseline (4.03× the original count — past the 4× milestone):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  285 (was 50)
- **Api.Tests**:          107 (was 105)

The 506 new tests split as:

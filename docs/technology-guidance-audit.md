...
The backend test suite grew from 167 to **622 tests** during the remediation — a 273% increase over the baseline (3.73× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  234 (was 50)
- **Api.Tests**:          107 (was 105)

The 455 new tests split as:

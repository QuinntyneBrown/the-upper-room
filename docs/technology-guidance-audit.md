...
The backend test suite grew from 167 to **520 tests** during the remediation — a 211% increase over the baseline (now over 3× the original count):

- **Domain.Tests**:       244 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  160 (was 50)
- **Api.Tests**:          107 (was 105)

The 353 new tests split as:

...
The backend test suite grew from 167 to **607 tests** during the remediation — a 263% increase over the baseline (3.63× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  219 (was 50)
- **Api.Tests**:          107 (was 105)

The 440 new tests split as:

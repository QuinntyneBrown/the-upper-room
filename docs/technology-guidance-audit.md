...
The backend test suite grew from 167 to **650 tests** during the remediation — a 289% increase over the baseline (3.89× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  262 (was 50)
- **Api.Tests**:          107 (was 105)

The 483 new tests split as:

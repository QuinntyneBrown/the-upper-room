...
The backend test suite grew from 167 to **611 tests** during the remediation — a 266% increase over the baseline (3.66× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  223 (was 50)
- **Api.Tests**:          107 (was 105)

The 444 new tests split as:

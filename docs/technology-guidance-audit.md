...
The backend test suite grew from 167 to **684 tests** during the remediation — a 310% increase over the baseline (4.10× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  296 (was 50)
- **Api.Tests**:          107 (was 105)

The 517 new tests split as:

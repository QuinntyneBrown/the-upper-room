...
The backend test suite grew from 167 to **543 tests** during the remediation — a 225% increase over the baseline (now over 3× the original count):

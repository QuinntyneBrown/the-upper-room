...
The backend test suite grew from 167 to **379 tests** during the remediation — a 127% increase over the baseline:

- **Domain.Tests**:       103 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  160 (was 50)
- **Api.Tests**:          107 (was 105)

The 212 new tests split as:

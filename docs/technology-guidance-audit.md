...
The backend test suite grew from 167 to **585 tests** during the remediation — a 250% increase over the baseline (the suite has now exactly tripled, +1):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  197 (was 50)
- **Api.Tests**:          107 (was 105)

The 418 new tests split as:

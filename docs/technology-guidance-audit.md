...
The backend test suite grew from 167 to **687 tests** during the remediation — a 311% increase over the baseline (4.11× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  299 (was 50)
- **Api.Tests**:          107 (was 105)

The 520 new tests split as:

...
The backend test suite grew from 167 to **395 tests** during the remediation — a 137% increase over the baseline:

- **Domain.Tests**:       119 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  160 (was 50)
- **Api.Tests**:          107 (was 105)

The 228 new tests split as:

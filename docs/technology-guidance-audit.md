...
The backend test suite grew from 167 to **578 tests** during the remediation — a 246% increase over the baseline (now over 3× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  190 (was 50)
- **Api.Tests**:          107 (was 105)

The 411 new tests split as:

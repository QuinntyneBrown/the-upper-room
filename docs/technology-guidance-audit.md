...
The backend test suite grew from 167 to **657 tests** during the remediation — a 293% increase over the baseline (3.93× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  269 (was 50)
- **Api.Tests**:          107 (was 105)

The 490 new tests split as:

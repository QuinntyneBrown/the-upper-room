...
The backend test suite grew from 167 to **681 tests** during the remediation — a 308% increase over the baseline (4.08× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  293 (was 50)
- **Api.Tests**:          107 (was 105)

The 514 new tests split as:

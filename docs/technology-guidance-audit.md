...
The backend test suite grew from 167 to **694 tests** during the remediation — a 316% increase over the baseline (4.16× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  306 (was 50)
- **Api.Tests**:          107 (was 105)

The 527 new tests split as:

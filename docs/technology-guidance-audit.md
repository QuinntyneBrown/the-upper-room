...
The backend test suite grew from 167 to **582 tests** during the remediation — a 248% increase over the baseline (now over 3× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  194 (was 50)
- **Api.Tests**:          107 (was 105)

The 415 new tests split as:

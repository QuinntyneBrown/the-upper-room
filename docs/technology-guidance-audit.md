...
The backend test suite grew from 167 to **592 tests** during the remediation — a 254% increase over the baseline (3.54× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  204 (was 50)
- **Api.Tests**:          107 (was 105)

The 425 new tests split as:

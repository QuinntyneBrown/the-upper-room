...
The backend test suite grew from 167 to **602 tests** during the remediation — a 261% increase over the baseline (3.61× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  214 (was 50)
- **Api.Tests**:          107 (was 105)

The 435 new tests split as:

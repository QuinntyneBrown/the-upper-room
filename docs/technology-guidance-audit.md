...
The backend test suite grew from 167 to **595 tests** during the remediation — a 256% increase over the baseline (3.56× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  207 (was 50)
- **Api.Tests**:          107 (was 105)

The 428 new tests split as:

...
The backend test suite grew from 167 to **696 tests** during the remediation — a 317% increase over the baseline (4.17× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  308 (was 50)
- **Api.Tests**:          107 (was 105)

The 529 new tests split as:

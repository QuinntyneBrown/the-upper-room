...
The backend test suite grew from 167 to **642 tests** during the remediation — a 284% increase over the baseline (3.84× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  254 (was 50)
- **Api.Tests**:          107 (was 105)

The 475 new tests split as:

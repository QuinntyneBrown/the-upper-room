...
The backend test suite grew from 167 to **654 tests** during the remediation — a 292% increase over the baseline (3.92× the original count):

- **Domain.Tests**:       272 (was 9)
- **Infrastructure.Tests**: 9 (was 3)
- **Application.Tests**:  266 (was 50)
- **Api.Tests**:          107 (was 105)

The 487 new tests split as:
